...
export const metadata = {
  title: "Ahmed Elzyat | Services",
  description: "Services offered by me.",
  keywords:
    "Ahmed Elzyat, Ahmed Elzyat, Services, Web Development, Software Development, Full Stack Development, Logo Design, Graphic Design, UI/UX Design, Video Editing, Content Writing, Documentation, Document Creation",
};
