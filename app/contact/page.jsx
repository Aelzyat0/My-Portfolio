...
export const metadata = {
  title: "Ahmed Elzyat | Contact",
  description:
    "Contact me for any inquiries or to discuss your project requirements.",
  keywords:
    "Ahmed Elzyat, Ahmed ,Elzyat, contact, contact me, contact form, contact information, contact details, contact page, contact form submission, contact form submission success, contact form submission failed",
};
